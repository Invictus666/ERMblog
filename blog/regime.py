...
def annualized_return_from_percent(returns):
  if len(returns) == 0:
    return np.nan
  return (1+returns/100).prod()**(252/len(returns))-1

def annualized_std_from_percent(returns):
  if len(returns) == 0:
    return np.nan
...
def analyse_regime(stocks_ticker):
  ...
  stocks_return = annualized_return_from_percent(stocks_data["Ret"])
  normal_return = annualized_return_from_percent(normal_data["Ret"])
  crash_return = annualized_return_from_percent(crash_data["Ret"])

  stocks_std = annualized_std_from_percent(stocks_data["Ret"])
...
def return_regime_graph(stock_ticker):
  ...
  stock_return = annualized_return_from_percent(stock_data["Ret"])
  normal_return = annualized_return_from_percent(normal_data["Ret"])
  crash_return = annualized_return_from_percent(crash_data["Ret"])
  ...
  stock_std = annualized_std_from_percent(stock_data["Ret"])
  normal_std = annualized_std_from_percent(normal_data["Ret"])
  crash_std = annualized_std_from_percent(crash_data["Ret"])
...
def return_portfolio_regime_graph(stock_list):
   ...
   stock_return = annualized_return_from_percent(regime_data["Ret"])
   normal_return = annualized_return_from_percent(normal_data["Ret"])
   crash_return = annualized_return_from_percent(crash_data["Ret"])
   ...
   stock_std = annualized_std_from_percent(regime_data["Ret"])
   normal_std = annualized_std_from_percent(normal_data["Ret"])
   crash_std = annualized_std_from_percent(crash_data["Ret"])
